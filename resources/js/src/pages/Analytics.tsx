...
const Analytics = () => {
    ...
    useEffect(() => {
        ...
        const getOsDetails = async () => {
            const response = await getRequest("/api/getVisitorOs", {}, headers);
            setOsDetails(response);
        }
        const getVisits = async () => {
            const response = await getRequest("/api/getVisits", {}, headers);
        ...
        const getBotVisits = async () => {
            const response = await getRequest("/api/getBotVisits", {}, headers);
